...
class InstrumentProfile(models.Model):
    ...
    instrument = models.OneToOne(Instrument, on_delete=models.CASCADE, related_name='profile')
    landing_page = models.URLField(null=True, blank=True)
    owner = models.CharField(max_length=400, null=False, blank=False, default='No Owner - Please Udate')
    owner_contact = models.CharField(max_length=400, null=True, blank=True)
    manufacturer = models.CharField(max_length=400, null=False, blank=False, default='No Manufacturer - Please Update')
