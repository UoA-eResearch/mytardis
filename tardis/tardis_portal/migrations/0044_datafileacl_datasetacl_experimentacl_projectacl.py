    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('group', models.ForeignKey(null=True, blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='projectacls', to='auth.Group')),
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='tardis_portal.Project')),
                ('user', models.ForeignKey(null=True, blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='projectacls', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'ordering': ['id'],
                'abstract': False,
